...
function StatusDot({ status }) {
  const colors = { good: "#0ea472", moderate: "#d97706", poor: "#dc2626", unknown: "#94a3b8" };
  const c = colors[status] || colors.unknown;
  return (
    <span style={{
      display: "inline-block", width: "7px", height: "7px",
      borderRadius: "50%", background: c,
      boxShadow: `0 0 4px ${c}80`, marginRight: "6px", flexShrink: 0,
    }} />
  );
}
...
function WaterStationCard({ navigate, stationCount }) {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/water-stations?state=Andhra Pradesh")
      ...
      .then(data => {
        ...
        data.forEach(s => { const st = deriveStatus(s.parameters); counts[st]++; });
        setSummary(counts);
      })
      .catch(() => {})
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
        ...
        <span style={{
          fontFamily: "monospace", fontSize: "10px", color: "#0e74bd",
          background: "rgba(14,116,189,0.08)", padding: "2px 8px",
          borderRadius: "4px", border: "1px solid rgba(14,116,189,0.15)",
        }}>
      ...
      {loading ? (
        ...
        <>
          <div style={{ display: "flex", gap: "5px", flexWrap: "wrap", marginBottom: "10px" }}>
            {[["good","#0ea472"],["moderate","#d97706"],["poor","#dc2626"]].map(([key, color]) => summary[key] > 0 && (
              <div key={key} style={{
                ...
                <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "10px", color, fontWeight: 500 }}>
                  {summary[key]}
                </span>
              </div>
            ))}
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // 1. Alerts — auto-refresh every 10s
    const fetchAlerts = () => {
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "22px 26px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "14px", marginBottom: "20px" }}>
              ...
              <StatCard
                ...
                value={
                  <span style={{ color: qualityColor(wqStatus), fontSize: "26px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "13px" }}>
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: "0 3px 12px rgba(14,116,189,0.28)",
                ...
                <motion.div
                  ...
                  style={{
                    background: "#fff", borderRadius: "12px",
                    border: "1px solid #e2eaf4", padding: "14px 16px",
                    cursor: "pointer", boxShadow: "0 1px 6px rgba(14,116,189,0.06)",
                    transition: "all 0.15s",
                  }}
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    <div style={{
                      ...
                      background: "rgba(14,116,189,0.08)", border: "1px solid rgba(14,116,189,0.15)",
