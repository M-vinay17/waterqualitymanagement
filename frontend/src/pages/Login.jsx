...
function WaterPanel() {
  return (
    <div style={{
      ...
      padding: "48px 40px", color: "#fff", height: "100%",
    }}>
      <style>{`
        ...
        .info-card { animation: fadeSlide 0.5s ease forwards; opacity: 0; }
      `}</style>
      ...
      <div style={{
        ...
        maxWidth:"260px", marginBottom:"40px",
      }}>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:"10px", width:"100%", maxWidth:"280px" }}>
        {[
          ...
          <div key={i} className="info-card" style={{
            ...
            background:"rgba(255,255,255,0.09)", backdropFilter:"blur(4px)",
            border:"1px solid rgba(255,255,255,0.14)",
          }}>
            <span style={{ fontSize:"16px" }}>{item.icon}</span>
            <span style={{ fontFamily:"'IBM Plex Mono', monospace", fontSize:"10px", color:"rgba(255,255,255,0.8)", letterSpacing:"0.04em" }}>
              {item.text}
            </span>
          </div>
        ))}
      ...
      {/* Bottom wave */}
      <svg viewBox="0 0 1440 80" style={{ position:"absolute", bottom:0, left:0, width:"100%", opacity:0.12 }}>
          ...
          <div style={{
            ...
            <div style={{ padding: "24px 28px", display: "flex", flexDirection: "column", gap: "18px" }}>
                ...
                {error && (
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                      ...
                      <button
                        onClick={() => setError("")}
                        style={{ marginLeft: "auto", background: "none", border: "none", cursor: "pointer", color: "#94a3b8", fontSize: "14px", flexShrink: 0 }}
                      >✕</button>
                    </div>
                  </motion.div>
                )}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <span style={{ fontSize: "9px", color: "#94a3b8", letterSpacing: "0.1em" }}>OR SIGN IN WITH EMAIL</span>
                <div style={{ flex: 1, height: "1px", background: "#f1f5f9" }} />
              </div>
