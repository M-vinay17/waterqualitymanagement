...
# Import models to register them with SQLAlchemy (important for create_all)
...
# Services
from app.services.ws_manager import ws_manager   # if needed globally
...
# Include Routers
# auth.router has prefix="/auth" inside auth.py → /auth/login, /auth/register
